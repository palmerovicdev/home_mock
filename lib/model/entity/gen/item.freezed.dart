...
class _$ItemCopyWithImpl<$Res>
  ...
  $Res call(
    ...
    return _then(Item(
      ...
      as String,
      title: null == title ? _self.title : title
      as String,
      city: null == city ? _self.city : city
      as String,
      imageUrl: null == imageUrl ? _self.imageUrl : imageUrl
      as String,
      price: null == price ? _self.price : price
      as int,
      category: null == category ? _self.category : category
      as Category,
      description: null == description ? _self.description : description
      as String,
      size: null == size ? _self.size : size
      as String,
      bedrooms: null == bedrooms ? _self.bedrooms : bedrooms
      as int,
      bathrooms: null == bathrooms ? _self.bathrooms : bathrooms
      as int,
      owner: null == owner ? _self.owner : owner
      as Owner,
      isFavorite: null == isFavorite ? _self.isFavorite : isFavorite
      as bool,
    ));
  }
